...
/* Lightweight, cookie-free visit counter (Abacus). Owner visits excluded via
   ?self=1 (sets a persistent localStorage flag). No PII, no cookies. */
(function(){try{
  var q=new URLSearchParams(location.search);
  if(q.has('self'))localStorage.setItem('vb-self','1');
